...
def main():
    ...
    desired_pos = np.matrix([[ 3.06161700e-17, 8.66025404e-01, -5.00000000e-01, 333],
                             [-1.00000000e+00, 0.00000000e+00, -5.55111512e-17, 333],
                             [-5.55111512e-17, 5.00000000e-01, 8.66025404e-01, 2],
                             [ 0, 0, 0, 1]])
    th = invKine(desired_pos)
    for i in range(0, len(th)):
        th[i] = np.degrees(th[i])
    print(th)
